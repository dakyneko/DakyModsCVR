...
namespace LagFreeScreenshots
{
    ...
    {
        internal static readonly AwaitProvider ourMainThreadQueue = new("LagFreeScreenshots.ToMainThread"); 
        internal static readonly AwaitProvider ourFrameEndQueue = new("LagFreeScreenshots.FrameEnd"); 
